...
* [EC2 instances whose types are larger than or equal to `t2.medium` should be chosen for the cluster to work reliably](https://github.com/kube-aws/kube-aws/issues/138)
* [At least 3 etcd, 2 controller, 2 worker nodes are required to achieve high availability](https://github.com/kube-aws/kube-aws/issues/138#issuecomment-266432162)
...
See [`cluster.yaml`](https://github.com/kube-aws/kube-aws/blob/master/builtin/files/cluster.yaml.tmpl) for more details.
