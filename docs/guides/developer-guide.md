...
Clone the [kube-aws repository](https://github.com/kube-aws/kube-aws) to the appropriate path under the GOPATH.

```bash
$ export GOPATH=$HOME/go
$ git clone git@github.com:kube-aws/kube-aws.git $GOPATH/src/github.com/kube-aws/kube-aws
```
